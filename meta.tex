...
\begin{itemize}
    ...
    Designed an abstract class to provide general logging interface.
    Adopted an inheritance approach, allowing users to create and modify subcontexts without affecting parents.
    ...
    \item Identified replicated tensors, allowing peer to peer caching upon checkpoint loading.
\end{itemize}
}
